...
def invia_email():
    ...
    <div style="font-size:12px;color:#444;line-height:1.4;">
      <div style="margin-top:10px;">
        ...
        Sig.  Ivan Debilio&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; +39 351 5105697<br><br>
...
def _genera_pdf_etichetta(articoli, formato, anteprima=False):
    ...
    def build_qr_flowable(value):
        try:
            ...
            side = 16 * mm   # abbastanza leggibile ma resta in una pagina
            scale_x = side / width if width else 1
            scale_y = side / height if height else 1

            drawing = Drawing(side, side)
            qr.transform = [scale_x, 0, 0, scale_y, 0, 0]
            drawing.add(qr)
            return drawing
        except Exception:
