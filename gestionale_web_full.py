...
#  Le route /lavorazioni e /stampa_picking_pdf sono state spostate in routes/picking.py
# ========================================================
...
# ========================================================
#  REGISTRAZIONE MODULO PICKING / LAVORAZIONI
# ========================================================
try:
    from routes.picking import register_picking_routes
    register_picking_routes(app, globals())
    print("[OK] modulo picking/lavorazioni registrato")
except Exception as e:
    scrivi_log_errore("Modulo picking/lavorazioni non registrato", e)
    print(f"[WARN] modulo picking/lavorazioni non registrato: {e}")
